...
identical to the combination of median and MAD, which have different IFs of
...
accepted in practical applicationas, the IF is bounded. Hence, the ML estimator 
...
Based on the diagnostic plot, the normal distribution seems to fit well to 
